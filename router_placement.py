...
if __name__ == '__main__':
    ...
    def genetic_algorithm(n_routers, population_size=50, generations=100):
        ...
        for _ in range(generations):
            fitness_scores = [1 / calculate_voltage_deviation(backward_forward_sweep(ind)) for ind in population]
        ...
        best_individual = max(population, key=lambda ind: 1 / calculate_voltage_deviation(backward_forward_sweep(ind)))
        return best_individual


    # Optimize router placement
    n_routers = 3  # Change this to the desired number of routers
    ...
    # Calculate final router capacities
